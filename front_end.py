...
with left_column:
    with st.container(border=True):
        ...
        done1 = st.button("Done", "done1")
        st.write("Step 3: Run setting again")
        st.write(
            "Step 4: Put in what settings you want in the newly created Input_setting.xlsx file and save (Ctrl+S) when you're done"
        )
        done2 = st.button("Done", "done2")
        st.write(
